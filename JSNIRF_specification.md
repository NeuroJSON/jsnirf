...
- [Grammar](#grammar)
- [JSNIRF Keywords](#jsnirf-keywords)
  * [NIRSHeader](#niftiheader)
    + [DataType (NIRS-1 header: datatype)](#datatype-nifti-1-header-datatype)
    + [DimInfo (NIRS-1 header: dim_info)](#diminfo-nifti-1-header-dim_info)
    + [Unit (NIRS-1 header: xyzt_units)](#unit-nifti-1-header-xyzt_units)
    + [NIIFormat (NIRS-1 header: magic)](#niiformat-nifti-1-header-magic)
    + [NIIHeaderSize (NIRS-1 header: sizeof_hdr)](#niiheadersize-nifti-1-header-sizeof_hdr)
